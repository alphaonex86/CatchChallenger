...
"}"));
        ...
        toolButton_2 = new QToolButton(IG_dialog);
...
"}"));
        ...
        QObject::connect(toolButton_2, SIGNAL(clicked()), IG_dialog, SLOT(hide()));

        stackedWidget->setCurrentIndex(12);
        tabWidgetTrainerCard->setCurrentIndex(0);
    ...
    void retranslateUi(QWidget *BaseWindowUI)
    {
        ...
        toolButton_2->setText(QApplication::translate("BaseWindowUI", "...", 0, QApplication::UnicodeUTF8));
