...
void OverMapLogic::goToBotStep(const uint8_t &step)
{
    ...
    else if(strcmp(stepXml->Attribute("type"),"shop")==0)
    {
        ...
        if(CatchChallenger::CommonDatapackServerSpec::commonDatapackServerSpec.shops.find(shopId)==CatchChallenger::CommonDatapackServerSpec::commonDatapackServerSpec.shops.cend())
        {
...
/*        if(actualBot.properties.find("skin")!=actualBot.properties.cend())
    ...
    else if(strcmp(stepXml->Attribute("type"),"industry")==0)
    {
        ...
        if(CatchChallenger::CommonDatapack::commonDatapack.industriesLink.find(factoryId)==CatchChallenger::CommonDatapack::commonDatapack.industriesLink.cend())
        {
...
bool OverMapLogic::nextStepQuest(const CatchChallenger::Quest &quest)
{
    ...
    if(playerInformations.quests.at(quest.id).step>quest.steps.size())
    {
        ...
        {
            appendReputationPoint(CatchChallenger::CommonDatapack::commonDatapack.reputation.at(
