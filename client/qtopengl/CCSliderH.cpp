...
void CCSliderH::paint(QPainter *painter, const QStyleOptionGraphicsItem *option, QWidget *widget)
{
    if(l.isNull())
    {
        const QPixmap *background=GameLoader::gameLoader->getImage(":/CC/images/interface/sliderBarH.png");
    ...
    const QPixmap *silderH=GameLoader::gameLoader->getImage(":/CC/images/interface/sliderH.png");
