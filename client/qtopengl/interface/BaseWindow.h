...
#include "../../qt/fight/interface/ClientFightEngine.h"
#include "../../qt/Api_protocol_Qt.h"
...
private slots:
    ...
    void * itemToGraphic(const uint16_t &itemid, const uint32_t &quantity);
    //player
    ...
    void factoryToProductItem(void *item);
    void factoryToResourceItem(void *item);
    ...
    //inventory
    void on_inventory_itemActivated(void *item);
    ...
    void on_listPlantList_itemActivated(void *item);
    ...
    void on_listCraftingList_itemActivated(void *);
    ...
    void on_shopItemList_itemActivated(void *item);
    ...
    void on_monsterList_itemActivated(void *item);
    void on_learnQuit_clicked();
    void on_learnValidate_clicked();
    void on_learnAttackList_itemActivated(void *item);
    void on_close_IG_dialog_clicked();
    void on_questsList_itemSelectionChanged();
    void on_listWidgetFightAttack_itemActivated(void *item);
    ...
    void on_warehousePlayerInventory_itemActivated(void *item);
    void on_warehousePlayerStoredInventory_itemActivated(void *item);
    void on_warehousePlayerMonster_itemActivated(void *item);
    void on_warehousePlayerStoredMonster_itemActivated(void *item);
    ...
    void on_factoryProducts_itemActivated(void *item);
    void on_factorySell_clicked();
    void on_factoryResources_itemActivated(void *item);
    ...
    void updateMarketObject(void *item,const MarketObject &marketObject);
    void on_marketObject_itemActivated(void *item);
    void on_marketOwnObject_itemActivated(void *item);
    void on_marketMonster_itemActivated(void *item);
    void on_marketOwnMonster_itemActivated(void *item);
    ...
    void on_characterEntryList_itemDoubleClicked(void *item);
    void on_listCraftingMaterials_itemActivated(void *item);
    ...
    void addToServerList(LogicialGroup &logicialGroup, void *item, const uint64_t &currentDate, const bool &fullView=true);
    ...
    void on_listWidgetEncyclopediaMonster_itemActivated(void *item);
    void on_listWidgetEncyclopediaItem_itemActivated(void *item);
    void on_listWidgetEncyclopediaMonster_itemChanged(void *item);
    void on_listWidgetEncyclopediaItem_itemChanged(void *item);
    ...
    void on_listNearPlayer_itemActivated(void *item);
    void on_listAllItem_itemActivated(void *item);
protected slots:
    //datapack
    void datapackParsed();
...
private:
    ...
    std::unordered_map<void *,uint16_t> items_graphical;
    std::unordered_map<uint16_t,void *> items_to_graphical;
    std::unordered_map<void *,uint16_t> shop_items_graphical;
    std::unordered_map<uint16_t,void *> shop_items_to_graphical;
    std::unordered_map<void *,uint8_t> plants_items_graphical;
    std::unordered_map<uint8_t,void *> plants_items_to_graphical;
    std::unordered_map<void *,uint16_t> crafting_recipes_items_graphical;
    std::unordered_map<uint16_t,void *> crafting_recipes_items_to_graphical;
    std::unordered_map<void *,uint16_t> fight_attacks_graphical;
    std::unordered_map<void *,uint8_t> monsterspos_items_graphical;
    std::unordered_map<void *,uint16_t> attack_to_learn_graphical;
    std::unordered_map<void *,uint16_t> quests_to_id_graphical;
    bool inSelection;
    ...
    std::unordered_map<uint8_t,void *> buffToGraphicalItemTop,buffToGraphicalItemBottom;
