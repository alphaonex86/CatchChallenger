...
void Chat::new_system_text(Pokecraft::Chat_type chat_type,QString text)
{
...
void Chat::new_chat_text(Pokecraft::Chat_type chat_type,QString text,QString pseudo,Pokecraft::Player_type type)
{
    #ifdef DEBUG_BASEWINDOWS
