...
class player : public QObject
{
    Q_OBJECT
public:
	player(QString skin, quint32 id = 0, QString MapName = QString());
    ~player();  
    ...
    void setInfo(Pokecraft::Player_public_informations info);
    void loadInfo(Pokecraft::Player_public_informations info);
...
public slots:
    ...
    void get_player_move(quint8 move, Pokecraft::Direction direc);
    void startRemove();
    void cancelRemove();
signals:
...
private:
    ...
    QString mapName;
    QString skinPath;
    Pokecraft::Player_public_informations data;
    spriteImage *sprite;
    QPointF pos;
    QTimer *timer;
