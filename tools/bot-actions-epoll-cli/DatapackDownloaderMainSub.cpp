...
{
    mDatapackMain=DatapackDownloaderBase::mDatapackBase+"map/main/"+mainDatapackCode+"/";
    ...
    if(!subDatapackCode.empty())
        mDatapackSub=DatapackDownloaderBase::mDatapackBase+"map/main/"+mainDatapackCode+"/sub/"+subDatapackCode+"/";
}
