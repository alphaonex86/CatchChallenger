...
public:
    ...
    static void add_to_inventory(CatchChallenger::Api_protocol *api, const std::vector<std::pair<uint16_t, uint32_t> > &items);
    static void add_to_inventory(CatchChallenger::Api_protocol *api, const std::unordered_map<uint16_t,uint32_t> &items);
    void add_to_inventory_slot(const std::unordered_map<uint16_t, uint32_t> &items);
    static void remove_to_inventory(CatchChallenger::Api_protocol *api,const std::unordered_map<uint16_t,uint32_t> &items);
    ...
    void setEvents(CatchChallenger::Api_protocol *api,const std::vector<std::pair<uint8_t,uint8_t> > &events);
    ...
    static bool canGoTo(CatchChallenger::Api_protocol *api, const CatchChallenger::Direction &direction, const MapServerMini &map, COORD_TYPE x, COORD_TYPE y, const bool &checkCollision, const bool &allowTeleport, const bool &debug=false);
