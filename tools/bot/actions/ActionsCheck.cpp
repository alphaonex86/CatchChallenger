...
bool ActionsAction::haveReputationRequirements(CatchChallenger::Api_protocol *api,const std::vector<CatchChallenger::ReputationRequirements> &reputationList) const
{
...
bool ActionsAction::haveReputationRequirements(CatchChallenger::Api_protocol *api,const QList<CatchChallenger::ReputationRequirements> &reputationList) const
{
    int index=0;
    while(index<reputationList.size())
    {
