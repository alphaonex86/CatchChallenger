...
public:
    ...
    //ONE PER QUALIFYING SHIP TILE: the player boards where they stand, so every
    //tile of the boat with ground beside it carries the push-teleport
    static std::map<std::pair<uint16_t,uint16_t>,std::vector<Tiled::MapObject*> > boatTeleportObjects;
