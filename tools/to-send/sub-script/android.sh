...
docker exec -it android_armv7_cc rm -Rf /home/user/src /home/user/build
...
docker exec -it android_armv7_cc /bin/bash /home/user/src/client/android-sources/build.sh
