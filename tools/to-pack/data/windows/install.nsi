...
!define PRODUCT_WEB_SITE "https://catchchallenger.first-world.info/"
!define PRODUCT_DIR_REGKEY "Software\Microsoft\Windows\CurrentVersion\App Paths\catchchallenger.exe"
...
; Finish page
!define MUI_FINISHPAGE_RUN "$INSTDIR\catchchallenger.exe"
...
Section "SectionPrincipale" SEC01
  SetOutPath "$INSTDIR"
  SetOverwrite on
  File "catchchallenger.exe"
  CreateDirectory "$SMPROGRAMS\CatchChallenger"
  CreateShortCut "$SMPROGRAMS\CatchChallenger\CatchChallenger.lnk" "$INSTDIR\catchchallenger.exe"
