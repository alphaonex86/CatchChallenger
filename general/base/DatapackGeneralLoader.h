...
public:
    ...
    static QList<ServerProfile> loadServerProfileList(const QString &datapackPath, const QString &file,const QHash<quint16, Item> &items,const QHash<quint16,Monster> &monsters,const QList<Reputation> &reputations,const QList<Profile> &profileCommon);
    static QList<ServerProfile> loadServerProfileListInternal(const QString &datapackPath, const QString &file,const QHash<quint16, Item> &items,const QHash<quint16,Monster> &monsters,const QList<Reputation> &reputations);
