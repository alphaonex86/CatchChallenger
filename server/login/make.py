"""
make.py — dynamic compile/link for catchchallenger-server-login.

Sources are auto-detected from login.pro (every SOURCES += entry, including
...
PRO_FILE = os.path.join(SCRIPT_DIR, 'login.pro')
TARGET_BIN = 'catchchallenger-server-login'
LINK_LIBS = ['-lpq', '-lzstd']
