...
_link_rc = os.system(CXX + MOLD_FLAGS + SAFESTACK_LINK + " -Wl,-z,relro -Wl,-z,now -Wl,-z,noexecstack -Wl,-z,separate-code -o " + os.path.join(BUILD_DIR, "catchchallenger-game-server-alone") + " " + " ".join(object_files) + " -lzstd -lz -lpq")
print('Finished')
if not has_success:
	sys.exit(123)
if _link_rc != 0:
