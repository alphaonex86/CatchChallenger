...
void MapVisibilityAlgorithm_Simple_StoreOnSender::put_on_the_map(const CATCHCHALLENGER_TYPE_MAPID &mapIndex, constuint8_t &x, constuint8_t &y, const Orientation &orientation)
{
    Client::put_on_the_map(mapIndex,x,y,orientation);
    loadOnTheMap();
}
...
void MapVisibilityAlgorithm_Simple_StoreOnSender::teleportValidatedTo(const CATCHCHALLENGER_TYPE_MAPID &mapIndex,const COORD_TYPE &x,const COORD_TYPE &y,const Orientation &orientation)
{
