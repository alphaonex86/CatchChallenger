...
void PreparedDBQueryCommon::initDatabaseQueryCommonWithoutSP(const DatabaseBase::DatabaseType &type, CatchChallenger::DatabaseBase * const database)
{
    switch(type)
    {
        ...
        PreparedDBQueryCommon::db_query_insert_monster="INSERT INTO `monster`(`id`,`character`,`place`,`hp`,`monster`,`level`,`xp`,`captured_with`,`gender`,`egg_step`,`character_origin`,`position`,`buffs`,`skills`,`skills_endurance`) "
                                                       "VALUES(%1,%2,%3,%4,%5,%6,0,0,%7,%8,0,%9,%10,'',UNHEX('%11'),UNHEX('%12'))";
        /*wild catch*/
        PreparedDBQueryCommon::db_query_insert_monster_full=PreparedStatementUnit("INSERT INTO `monster`(`id`,`character`,`place`,`hp`,`monster`,`level`,`xp`,`captured_with`,`gender`,`egg_step`,`character_origin`,`position`,`buffs`,`skills`,`skills_endurance`) "
        ...
        PreparedDBQueryCommon::db_query_insert_warehouse_monster=PreparedStatementUnit("INSERT INTO `monster`(`id`,`hp`,`monster`,`level`,`xp`,`captured_with`,`gender`,`egg_step`,`character_origin`,`skills`,`skills_endurance`) "
        ...
        PreparedDBQueryCommon::db_query_delete_monster_by_id=PreparedStatementUnit("DELETE FROM monster WHERE id=%1",database);
        PreparedDBQueryCommon::db_query_insert_monster="INSERT INTO monster(id,character,place,hp,monster,level,xp,captured_with,gender,egg_step,character_origin,position,buffs,skills,skills_endurance) "
                                                       "VALUES(%1,%2,%3,%4,%5,%6,0,%7,%8,0,%9,%10,'','%11','%12')";
        /*wild catch*/
        PreparedDBQueryCommon::db_query_insert_monster_full=PreparedStatementUnit("INSERT INTO monster(id,character,place,hp,monster,level,xp,captured_with,gender,egg_step,character_origin,position,buffs,skills,skills_endurance) "
                                                       "VALUES(%1,%2,%3,%4,%5,%6,0,%7,%8,0,%9,%10,'%11','%12','%13')",database);
        ...
        PreparedDBQueryCommon::db_query_delete_monster_buff=PreparedStatementUnit("UPDATE monster SET buffs='' WHERE id=%1",database);
        PreparedDBQueryCommon::db_query_insert_warehouse_monster=PreparedStatementUnit("INSERT INTO monster(id,hp,monster,level,xp,captured_with,gender,egg_step,character_origin,skills,skills_endurance) "
                                                       "VALUES(%1,%2,%3,%4,0,%5,%6,0,%7,'%8','%9')",database);
        PreparedDBQueryCommon::db_query_update_monster_position=PreparedStatementUnit("UPDATE monster SET position=%1 WHERE id=%2",database);
        PreparedDBQueryCommon::db_query_update_monster_position_and_place=PreparedStatementUnit("UPDATE monster SET position=%1,place=%2 WHERE id=%3",database);
        PreparedDBQueryCommon::db_query_update_monster_place=PreparedStatementUnit("UPDATE monster SET place=%1 WHERE id=%2",database);
        PreparedDBQueryCommon::db_query_update_monster_and_hp=PreparedStatementUnit("UPDATE monster SET hp=%1,monster=%2 WHERE id=%3",database);
        ...
        PreparedDBQueryCommon::db_query_delete_monster_by_id=PreparedStatementUnit("DELETE FROM monster WHERE id=%1",database);
        PreparedDBQueryCommon::db_query_insert_monster="INSERT INTO monster(id,character,place,hp,monster,level,xp,captured_with,gender,egg_step,character_origin,position,buffs,skills,skills_endurance) "
                                                       "VALUES(%1,%2,%3,%4,%5,%6,0,%7,%8,0,%9,%10,'',decode('%11','hex'),decode('%12','hex'))";
        /*wild catch*/
        PreparedDBQueryCommon::db_query_insert_monster_full=PreparedStatementUnit("INSERT INTO monster(id,character,place,hp,monster,level,xp,captured_with,gender,egg_step,character_origin,position,buffs,skills,skills_endurance) "
                                                       "VALUES(%1,%2,%3,%4,%5,%6,0,%7,%8,0,%9,%10,decode('%11','hex'),decode('%12','hex'),decode('%13','hex'))",database);
        ...
        PreparedDBQueryCommon::db_query_delete_monster_buff=PreparedStatementUnit("UPDATE monster SET buffs='' WHERE id=%1",database);
        PreparedDBQueryCommon::db_query_insert_warehouse_monster=PreparedStatementUnit("INSERT INTO monster(id,hp,monster,level,xp,captured_with,gender,egg_step,character_origin,skills,skills_endurance) "
                                                       "VALUES(%1,%2,%3,%4,0,%5,%6,0,%7,decode('%8','hex'),decode('%9','hex'))",database);
        PreparedDBQueryCommon::db_query_update_monster_position=PreparedStatementUnit("UPDATE monster SET position=%1 WHERE id=%2",database);
        PreparedDBQueryCommon::db_query_update_monster_position_and_place=PreparedStatementUnit("UPDATE monster SET position=%1,place=%2 WHERE id=%3",database);
        PreparedDBQueryCommon::db_query_update_monster_place=PreparedStatementUnit("UPDATE monster SET place=%1 WHERE id=%2",database);
        PreparedDBQueryCommon::db_query_update_monster_and_hp=PreparedStatementUnit("UPDATE monster SET hp=%1,monster=%2 WHERE id=%3",database);
...
void PreparedDBQueryCommon::initDatabaseQueryCommonWithSP(const DatabaseBase::DatabaseType &type, CatchChallenger::DatabaseBase * const database)
{
    (void)database;
    switch(type)
    {
