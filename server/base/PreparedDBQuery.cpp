...
QString PreparedDBQueryServer::db_query_select_plant=NULL;
QString PreparedDBQueryServer::db_query_delete_plant=NULL;
QString PreparedDBQueryServer::db_query_delete_plant_by_index=NULL;
...
QString PreparedDBQueryServer::db_query_insert_bot_already_beaten=NULL;
QString PreparedDBQueryServer::db_query_delete_bot_already_beaten=NULL;

QString PreparedDBQueryCommon::db_query_select_monstersBuff_by_id=NULL;
...
void PreparedDBQueryServer::initDatabaseQueryServer(const DatabaseBase::Type &type)
{
    switch(type)
    {
        ...
        PreparedDBQueryServer::db_query_select_plant=QStringLiteral("SELECT `pointOnMap`,`plant`,`plant_timestamps` FROM `plant` WHERE `character`=%1");
        PreparedDBQueryServer::db_query_delete_plant=QStringLiteral("DELETE FROM `plant` WHERE `character`=%1");
        PreparedDBQueryServer::db_query_delete_plant_by_index=QStringLiteral("DELETE FROM `plant` WHERE `character`=%1 AND `pointOnMap`=%2");
        ...
        PreparedDBQueryServer::db_query_select_itemOnMap=QStringLiteral("SELECT `pointOnMap` FROM `character_itemonmap` WHERE `character`=%1 ORDER BY `pointOnMap`");
        PreparedDBQueryServer::db_query_insert_itemonmap=QStringLiteral("INSERT INTO `character_itemonmap`(`character`,`pointOnMap`) VALUES(%1,%2)");
        ...
        PreparedDBQueryServer::db_query_insert_plant=QStringLiteral("INSERT INTO `plant`(`character`,`pointOnMap`,`plant`,`plant_timestamps`) VALUES(%1,%2,%3,%4);");
