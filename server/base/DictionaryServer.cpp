...
std::unordered_map<std::string,std::unordered_map<std::pair<uint8_t/*x*/,uint8_t/*y*/>,uint16_t/*db code*/,pairhash> > DictionaryServer::dictionary_pointOnMap_internal_to_database;
