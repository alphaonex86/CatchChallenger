...
public:
    ...
    static std::vector<uint8_t> dictionary_skin_internal_to_database;//255 == not found
    static std::vector<uint8_t> dictionary_starter_internal_to_database;//255 == not found
    #endif
};
}
