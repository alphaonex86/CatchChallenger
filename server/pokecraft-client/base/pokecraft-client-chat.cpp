#include "pokecraft-client-chat.h"

QString Pokecraft_client_chat::new_chat_message(QString pseudo,Player_type player_type,Chat_type chat_type,QString text)
{
	...
	switch(player_type)
	{
		...
		break;
		case Player_type_premium://premium player
			returned_html+="<img src=\":/images/chat/pokeballPremium.png\" alt\"\" />";
		break;
		case Player_type_gm://gm
			returned_html+="<img src=\":/images/chat/pokeballAdmin.png\" alt\"\" />";
		break;
		case Player_type_dev://dev
			returned_html+="<img src=\":/images/chat/pokeballDeveloper.png\" alt\"\" />";
		break;
		default:
		break;
	}
...
QString Pokecraft_client_chat::toHtmlEntities(QString text)
{
	text.replace("&","&amp;");
	text.replace("\"","&quot;");
	text.replace("'","&#039;");
...
QString Pokecraft_client_chat::toSmilies(QString text)
{
