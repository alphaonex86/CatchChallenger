...
#define CATCHCHALLENGER_SERVER_DATAPACK_FILEPURGE_KB 50
#define CATCHCHALLENGER_SERVER_DATAPACK_ZLIB_COMPRESSEDFILEPURGE_KB 300
#define CATCHCHALLENGER_SERVER_DATAPACK_XZ_COMPRESSEDFILEPURGE_KB 600
