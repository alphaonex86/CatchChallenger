...
class EventLoopClientLoginMaster : public EventLoopClient, public ProtocolParsingInputOutput
{
public:
    EventLoopClientLoginMaster(
            const int &infd
        );
    ~EventLoopClientLoginMaster();
    ...
    enum EventLoopClientLoginMasterStat : std::uint8_t
    {
        None,
        Logged,
        GameServer,
    ...
    EventLoopClientLoginMasterStat stat;
    std::mt19937 rng;
    ...
    EventLoopClientLoginMaster * inConflicWithTheMainServer;
    std::vector<EventLoopClientLoginMaster *> secondServerInConflict;
    uint8_t queryNumberInConflicWithTheMainServer;

    struct DataForSelectedCharacterReturn
    {
        EventLoopClientLoginMaster * loginServer;
    ...
    static std::vector<EventLoopClientLoginMaster *> gameServers;
    static std::vector<EventLoopClientLoginMaster *> loginServers;
    ...
    {
        std::vector<EventLoopClientLoginMaster *> addServer;
